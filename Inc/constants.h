...
#define DIST_PER_REVOLUTION WHEEL_RADIUS*M_PI // 217.879 // 214.66 // 206.5//214.635// 210.481 //304.734 // Distance traveled for a full 	wheel revolution (in mm)
#define VOIE 205.10
#define TICKS_PER_DEG VOIE * TICKS_PER_REVOLUTION/(DIST_PER_REVOLUTION*360.0) //450.0//91.472 // 91.290 // 91.108345 // 91.001144 // 91.055 	// 89.28//89//89.06 //4.86          // Nb of diff tick (enc1 - enc2) it takes to rotate 1 deg (old value: 4.7)
#endif
